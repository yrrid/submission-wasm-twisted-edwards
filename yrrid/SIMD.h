...
***/
  ...
  inline I128 i64x2_or(I128 a, I128 b) {
  ...
  inline I128 u64x2_shr(I128 x, int bits) {
    return wasm_u64x2_shr(x, bits);
  }

  inline I128 i64x2_shl(I128 x, int bits) {
    return wasm_i64x2_shl(x, bits);
  }
  ...
  static inline I128 i64x2_or(I128 a, I128 b) {
  ...
  static inline I128 i64x2_shl(I128 x, int bits) {
    return _mm_slli_epi64(x, bits);
  }
